...
var commands = {
    ...
    "!link": {
    	...
    	process: function(bot, msg) {
    		...
    		if(currentSong.loaderUrl) {
    			bot.sendMessage(msg.channel, currentSong.loaderUrl);
    		}
    		else if (currentSong.permalink_url) {
    			bot.sendMessage(msg.channel, currentSong.permalink_url);
    		}
    	}
    },
    "!list": {
